...
% Uppgift4 illustrates findings in problems 1.4 & 1.5  in the book 
% "Computational Structural Dynamics - Model Calibration and Validation" by 
% Thomas Abrahamsson.
clear all;

%% a)
%ändrade outputen från () till [];
